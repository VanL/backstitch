    ...
    *,
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "backstitch-release-publication",
...
def _require_expected_release_target(
    ...
    if target != expected_sha:
        raise RuntimeError(
            "GitHub Release target_commitish does not match expected release SHA; "
            f"expected={expected_sha}, observed={target!r}"
        )
