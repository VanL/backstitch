...
For `backstitch` specifically, the contractual probe list lives in
`docs/specs/02-backstitch-core.md` [SC-10] and is housed in
`tests/acceptance/`. This runbook is the generic pattern for other tools and
repos.
