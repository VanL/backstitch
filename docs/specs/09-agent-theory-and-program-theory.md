...
Status: Reference — definitional primer. Adopted from agent-theory @
`ec716e8` via `docs/plans/2026-08-08-agent-theory-delta-wave-propagation-plan.md`
(lands as `09-` here; the hub's slot `02-` is backstitch's core spec).
...
Verification: Consistency with the hub account (the agent-theory
repository's own program theory) and
...
| **The agent-theory repository** (the hub; not this one) | The reference operating model and starter corpus for applying the discipline |
...
| Need | Go to |
|------|--------|
| This repository's identity account | `docs/program-theory.md` (backstitch product theory, Active 2026-08-08) |
...
- hub plan (agent-theory repository, not a local path):
  "2026-07-30-program-theory-and-module-theory"
- `docs/plans/2026-08-08-agent-theory-delta-wave-propagation-plan.md`
  (this repository's adoption wave)
